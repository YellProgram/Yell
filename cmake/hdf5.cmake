function(DownloadBitshuffleFor targetName)
    ...
    target_link_libraries(${targetName} PUBLIC bitshuffle)
endfunction()
...
function(DownloadHDF5For targetName)
    ...
    if (HDF5_FOUND AND NOT CMAKE_TOTAL_STATIC)
        ...
        target_link_libraries(${targetName} PUBLIC hdf5)
        ...
        target_link_libraries(${targetName} PUBLIC hdf5_local hdf5_local_cpp)
